/*******************************************************************************
* File Name: ADC_Side_Rangefinder.c  
* Version 2.30
*
* Description:
...
volatile uint8 ADC_Side_Rangefinder_convDone = 0u;

/* Software flag to stop conversion for single sample conversion mode 
   with resolution above 16 bits */
volatile uint8 ADC_Side_Rangefinder_stopConversion = 0u;

/* To run the initialization block only at the start up */
uint8 ADC_Side_Rangefinder_initVar = 0u;

/* To check whether ADC started or not before switching the configuration */
volatile uint8 ADC_Side_Rangefinder_started = 0u;

/* Flag to hold ADC config number. By default active config is 1. */
volatile uint8 ADC_Side_Rangefinder_Config = 1u;

volatile int32 ADC_Side_Rangefinder_Offset = 0u;
volatile int32 ADC_Side_Rangefinder_CountsPerVolt = (uint32)ADC_Side_Rangefinder_CFG1_COUNTS_PER_VOLT;
...
/****************************************************************************** 
* Function Name: ADC_Side_Rangefinder_Init
*******************************************************************************
*
* Summary:
...
void ADC_Side_Rangefinder_Init(void) 
{
    ...
    ADC_Side_Rangefinder_InitConfig(1);

    /* This is only valid if there is an internal clock */
    #if(ADC_Side_Rangefinder_DEFAULT_INTERNAL_CLK)
        ADC_Side_Rangefinder_theACLK_SetMode(CYCLK_DUTY);
    #endif /* ADC_Side_Rangefinder_DEFAULT_INTERNAL_CLK */
    
    /* Set the duty cycle for charge pump clock */
    ADC_Side_Rangefinder_Ext_CP_Clk_SetMode(CYCLK_DUTY);

    /* To perform ADC calibration */
    ADC_Side_Rangefinder_GainCompensation(ADC_Side_Rangefinder_CFG1_RANGE, 
                                      ADC_Side_Rangefinder_CFG1_IDEAL_DEC_GAIN, 
                                      ADC_Side_Rangefinder_CFG1_IDEAL_ODDDEC_GAIN, 
                                      ADC_Side_Rangefinder_CFG1_RESOLUTION);        
}


/******************************************************************************
* Function Name: ADC_Side_Rangefinder_Enable
*******************************************************************************
*
* Summary: 
...
void ADC_Side_Rangefinder_Enable(void) 
{
    ...
    ADC_Side_Rangefinder_PWRMGR_DEC_REG |= ADC_Side_Rangefinder_ACT_PWR_DEC_EN;
    ADC_Side_Rangefinder_PWRMGR_DSM_REG |= ADC_Side_Rangefinder_ACT_PWR_DSM_EN;
    
     /* Enable alternative active mode power for ADC */
    ADC_Side_Rangefinder_STBY_PWRMGR_DEC_REG |= ADC_Side_Rangefinder_STBY_PWR_DEC_EN;
    #if (CY_PSOC3 || CY_PSOC5LP)
    ADC_Side_Rangefinder_STBY_PWRMGR_DSM_REG |= ADC_Side_Rangefinder_STBY_PWR_DSM_EN;
    ...
    if (ADC_Side_Rangefinder_Config == 1u)
	{
	    ...
	    ADC_Side_Rangefinder_DSM_CR17_REG |= (ADC_Side_Rangefinder_DSM_EN_BUF_VREF | ADC_Side_Rangefinder_DSM_EN_BUF_VCM);
	    #if ((ADC_Side_Rangefinder_CFG1_REFERENCE == ADC_Side_Rangefinder_EXT_REF_ON_P03) || \
	         (ADC_Side_Rangefinder_CFG1_REFERENCE == ADC_Side_Rangefinder_EXT_REF_ON_P32))
	        ADC_Side_Rangefinder_DSM_CR17_REG &= ~ADC_Side_Rangefinder_DSM_EN_BUF_VREF;
	    #endif /* Check for exteranl reference option */
	    #if ((ADC_Side_Rangefinder_CFG1_RANGE == ADC_Side_Rangefinder_IR_VSSA_TO_2VREF) && \
	          (CY_PSOC3 || CY_PSOC5LP) && \
	          ((ADC_Side_Rangefinder_CFG1_REFERENCE != ADC_Side_Rangefinder_EXT_REF_ON_P03) && \
	         (ADC_Side_Rangefinder_CFG1_REFERENCE != ADC_Side_Rangefinder_EXT_REF_ON_P32)))
    ...
    ADC_Side_Rangefinder_PUMP_CR1_REG  |= ( ADC_Side_Rangefinder_PUMP_CR1_CLKSEL | ADC_Side_Rangefinder_PUMP_CR1_FORCE );
 
    /* This is only valid if there is an internal clock */
    #if(ADC_Side_Rangefinder_DEFAULT_INTERNAL_CLK)
        ADC_Side_Rangefinder_PWRMGR_CLK_REG |= ADC_Side_Rangefinder_ACT_PWR_CLK_EN;        
        ADC_Side_Rangefinder_STBY_PWRMGR_CLK_REG |= ADC_Side_Rangefinder_STBY_PWR_CLK_EN;
    #endif /* ADC_Side_Rangefinder_DEFAULT_INTERNAL_CLK */
    
    /* Enable the active and alternate active power for charge pump clock */
    ADC_Side_Rangefinder_PWRMGR_CHARGE_PUMP_CLK_REG |= ADC_Side_Rangefinder_ACT_PWR_CHARGE_PUMP_CLK_EN;
    ADC_Side_Rangefinder_STBY_PWRMGR_CHARGE_PUMP_CLK_REG |= ADC_Side_Rangefinder_STBY_PWR_CHARGE_PUMP_CLK_EN;
    ...
    ***************************************************************************/
    void ADC_Side_Rangefinder_SetLowPower(void) 
    {
        ...
        ADC_Side_Rangefinder_DSM_CR15_REG &= ~(ADC_Side_Rangefinder_DSM_POWER2_3_MASK | ADC_Side_Rangefinder_DSM_POWER_COMP_MASK);
        ADC_Side_Rangefinder_DSM_CR15_REG |= (ADC_Side_Rangefinder_DSM_POWER2_3_LOW | ADC_Side_Rangefinder_DSM_POWER_VERYLOW);
        
        ADC_Side_Rangefinder_DSM_CR16_REG &= ~(ADC_Side_Rangefinder_DSM_CP_PWRCTL_MASK | ADC_Side_Rangefinder_DSM_POWER_SUM_MASK |
                                           ADC_Side_Rangefinder_DSM_CP_ENABLE);
        ADC_Side_Rangefinder_DSM_CR16_REG |= (ADC_Side_Rangefinder_DSM_POWER_SUM_LOW | ADC_Side_Rangefinder_DSM_CP_PWRCTL_LOW);
        
        ADC_Side_Rangefinder_DSM_CR17_REG &= ~(ADC_Side_Rangefinder_DSM_EN_BUF_VREF | ADC_Side_Rangefinder_DSM_PWR_CTRL_VCM_MASK |
                                           ADC_Side_Rangefinder_DSM_PWR_CTRL_VREF_MASK | ADC_Side_Rangefinder_DSM_EN_BUF_VCM |
                                           ADC_Side_Rangefinder_DSM_PWR_CTRL_VREF_INN_MASK);
        ADC_Side_Rangefinder_DSM_CR17_REG |= (ADC_Side_Rangefinder_DSM_PWR_CTRL_VREF_0 | ADC_Side_Rangefinder_DSM_PWR_CTRL_VCM_0 |
                                           ADC_Side_Rangefinder_DSM_PWR_CTRL_VREF_INN_0);
        
        /* Disable reference buffers */
        ADC_Side_Rangefinder_DSM_REF0_REG &= ~(ADC_Side_Rangefinder_DSM_EN_BUF_VREF_INN | ADC_Side_Rangefinder_DSM_VREF_RES_DIV_EN |
        ...
        ADC_Side_Rangefinder_DSM_CLK_REG &= ~(ADC_Side_Rangefinder_DSM_CLK_CLK_EN | ADC_Side_Rangefinder_DSM_CLK_BYPASS_SYNC);
    }
#endif /* CY_PSOC5A */


/******************************************************************************* 
* Function Name: ADC_Side_Rangefinder_Start
********************************************************************************
*
* Summary:
...
*
* Global variables:
*  ADC_Side_Rangefinder_initVar:  Used to check the initial configuration,
*  modified when this function is called for the first time.
*
*******************************************************************************/
void ADC_Side_Rangefinder_Start() 
{
    if(ADC_Side_Rangefinder_initVar == 0u)
    {
        if(!(ADC_Side_Rangefinder_started))
        {
            ADC_Side_Rangefinder_Init();
        }
        ADC_Side_Rangefinder_initVar = 1u;
    }
...
/*******************************************************************************
* Function Name: ADC_Side_Rangefinder_Stop
********************************************************************************
*
* Summary:
...
{
    /* Stop conversions */
    ADC_Side_Rangefinder_DEC_CR_REG &= ~ADC_Side_Rangefinder_DEC_START_CONV;
    ADC_Side_Rangefinder_DEC_SR_REG |=  ADC_Side_Rangefinder_DEC_INTR_CLEAR;
...
/*******************************************************************************
* Function Name: ADC_Side_Rangefinder_SetBufferGain
********************************************************************************
*
* Summary:
...
{
    uint8 tmpReg;
    tmpReg = ADC_Side_Rangefinder_DSM_BUF1_REG & ~ADC_Side_Rangefinder_DSM_GAIN_MASK;
    tmpReg |= (gain << 2);
    ADC_Side_Rangefinder_DSM_BUF1_REG = tmpReg;
}


/*******************************************************************************
* Function Name: ADC_Side_Rangefinder_SetCoherency
********************************************************************************
*
* Summary:
...
{
    uint8 tmpReg;    
    tmpReg = ADC_Side_Rangefinder_DEC_COHER_REG & ~ADC_Side_Rangefinder_DEC_SAMP_KEY_MASK;
    tmpReg |= coherency;
    ADC_Side_Rangefinder_DEC_COHER_REG = tmpReg;
}


/*******************************************************************************
* Function Name: ADC_Side_Rangefinder_SetGCOR
********************************************************************************
*
* Summary:
...
uint8 ADC_Side_Rangefinder_SetGCOR(float gainAdjust) 
{
    ...
    tmpReg = ADC_Side_Rangefinder_DEC_GCORH_REG;
    tmpReg = (tmpReg << 8) | ADC_Side_Rangefinder_DEC_GCOR_REG;
    tmpValue = ((float)tmpReg / ADC_Side_Rangefinder_IDEAL_GAIN_CONST);
    ...
    {
        tmpReg = (uint16)(tmpValue * ADC_Side_Rangefinder_IDEAL_GAIN_CONST);
        ADC_Side_Rangefinder_DEC_GCOR_REG = (uint8)tmpReg;
        ADC_Side_Rangefinder_DEC_GCORH_REG = (uint8) (tmpReg >> 8);
        status = 0;
    }
...
/******************************************************************************
* Function Name: ADC_Side_Rangefinder_ReadGCOR
*******************************************************************************
*
* Summary:
...
uint16 ADC_Side_Rangefinder_ReadGCOR(void) 
{
    ...
    gValue = ADC_Side_Rangefinder_DEC_GVAL_REG;
    gcorRegValue = CY_GET_REG16(ADC_Side_Rangefinder_DEC_GCOR_PTR);
    
    switch (gValue)
    {
        case ADC_Side_Rangefinder_GVAL_RESOLUTIN_8:
            gcorValue = gcorRegValue << (ADC_Side_Rangefinder_MAX_GVAL - gValue);
            break;
        
        case ADC_Side_Rangefinder_GVAL_RESOLUTIN_9:
            gcorValue = gcorRegValue << (ADC_Side_Rangefinder_MAX_GVAL - gValue);
            break;
            
        case ADC_Side_Rangefinder_GVAL_RESOLUTIN_10:
            gcorValue = gcorRegValue << (ADC_Side_Rangefinder_MAX_GVAL - gValue);
            break;
            
        case ADC_Side_Rangefinder_GVAL_RESOLUTIN_11:
            gcorValue = gcorRegValue << (ADC_Side_Rangefinder_MAX_GVAL - gValue);
            break;
            
        case ADC_Side_Rangefinder_GVAL_RESOLUTIN_12:
            gcorValue = gcorRegValue << (ADC_Side_Rangefinder_MAX_GVAL - gValue);
            break;
            
        case ADC_Side_Rangefinder_GVAL_RESOLUTIN_13:
            gcorValue = gcorRegValue << (ADC_Side_Rangefinder_MAX_GVAL - gValue);
            break;
...
/*******************************************************************************
* Function Name: ADC_Side_Rangefinder_SetBufferChop
********************************************************************************
*
* Summary:
...
void ADC_Side_Rangefinder_SetBufferChop(uint8 chopen, uint8 chopFreq) 
{
    if(chopen != 0u)
    {
        ADC_Side_Rangefinder_DSM_BUF2_REG = (ADC_Side_Rangefinder_DSM_BUF_FCHOP_MASK & chopFreq) | \
                                         ADC_Side_Rangefinder_DSM_BUF_CHOP_EN;
    }
    else
    {
        ADC_Side_Rangefinder_DSM_BUF2_REG = 0x00u;
    }
}


/*******************************************************************************
* Function Name: ADC_Side_Rangefinder_StartConvert
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: ADC_Side_Rangefinder_StopConvert
********************************************************************************
*
* Summary:
*  Starts ADC conversion using the given mode.
...
*
* Global variables:
*  ADC_Side_Rangefinder_convDone:  Modified when conversion is complete for single
...
void ADC_Side_Rangefinder_StopConvert(void) 
{
    ...
    ADC_Side_Rangefinder_convDone = 1u;
}


/*******************************************************************************
* Function Name: ADC_Side_Rangefinder_IsEndConversion
********************************************************************************
*
* Summary:
...
*
* Global variables:
*  ADC_Side_Rangefinder_convDone:  Used to check whether conversion is complete
*  or not for single sample mode with resolution is above 16
*
*******************************************************************************/
uint8 ADC_Side_Rangefinder_IsEndConversion(uint8 wMode) 
{
    uint8 status;
        
    /* Check for stop convert if conversion mode is Single Sample with 
       resolution above 16 bit */
    if(ADC_Side_Rangefinder_stopConversion == 1u)
    {
        do
        {
            status = ADC_Side_Rangefinder_convDone;
        } while((status != ADC_Side_Rangefinder_DEC_CONV_DONE) && (wMode == ADC_Side_Rangefinder_WAIT_FOR_RESULT));
    }
    else
    {
        do 
        {
            status = ADC_Side_Rangefinder_DEC_SR_REG & ADC_Side_Rangefinder_DEC_CONV_DONE;
        } while((status != ADC_Side_Rangefinder_DEC_CONV_DONE) && (wMode == ADC_Side_Rangefinder_WAIT_FOR_RESULT));
    }
    return(status);
}
...
/*******************************************************************************
* Function Name: ADC_Side_Rangefinder_GetResult8
********************************************************************************
*
* Summary:
...
{
     return( ADC_Side_Rangefinder_DEC_SAMP_REG );
}


/*******************************************************************************
* Function Name: ADC_Side_Rangefinder_GetResult16
********************************************************************************
*
* Summary:
...
int16 ADC_Side_Rangefinder_GetResult16(void) 
{
    ...
    #if (CY_PSOC3)
        result = ADC_Side_Rangefinder_DEC_SAMPM_REG ;
        result = (result << 8 ) | ADC_Side_Rangefinder_DEC_SAMP_REG;
    #else
...
/*******************************************************************************
* Function Name: ADC_Side_Rangefinder_GetResult32
********************************************************************************
*
* Summary:
...
int32 ADC_Side_Rangefinder_GetResult32(void) 
{
    uint32 result;
        ...
        result = (int8) (0xff & ADC_Side_Rangefinder_DEC_SAMPH_REG); 
        result = (result << 8) | ADC_Side_Rangefinder_DEC_SAMPM_REG;
        result = (result << 8) | ADC_Side_Rangefinder_DEC_SAMP_REG;
    #else
...
/*******************************************************************************
* Function Name: ADC_Side_Rangefinder_SetOffset
********************************************************************************
*
* Summary:
...
*
* Global variables:
*  ADC_Side_Rangefinder_Offset:  Modified to set the user provided offset. This 
*  variable is used for offset calibration purpose.
*  Affects the ADC_Side_Rangefinder_CountsTo_Volts, 
*  ADC_Side_Rangefinder_CountsTo_mVolts, ADC_Side_Rangefinder_CountsTo_uVolts functions 
...
void ADC_Side_Rangefinder_SetOffset(int32 offset) 
{
    ...
    ADC_Side_Rangefinder_Offset = offset;
}


/*******************************************************************************
* Function Name: ADC_Side_Rangefinder_SetGain
********************************************************************************
*
* Summary:
...
*
* Global variables:
*  ADC_Side_Rangefinder_CountsPerVolt:  modified to set the ADC gain in counts 
*   per volt.
*
*******************************************************************************/
void ADC_Side_Rangefinder_SetGain(int32 adcGain) 
{
    ...
    ADC_Side_Rangefinder_CountsPerVolt = adcGain;
}


/*******************************************************************************
* Function Name: ADC_Side_Rangefinder_CountsTo_mVolts
********************************************************************************
*
* Summary:
...
*
* Global variables:
*  ADC_Side_Rangefinder_CountsPerVolt:  used to convert ADC counts to mVolts.
*  ADC_Side_Rangefinder_Offset:  Used as the offset while converting ADC counts 
*   to mVolts.
*
*******************************************************************************/
int16 ADC_Side_Rangefinder_CountsTo_mVolts( int32 adcCounts) 
{
    ...
    /* Subtract ADC offset */
    adcCounts -= ADC_Side_Rangefinder_Offset;
	
	/* Set the resolution based on the configuration */
	if (ADC_Side_Rangefinder_Config == ADC_Side_Rangefinder_CFG1)
	{
        resolution = ADC_Side_Rangefinder_CFG1_RESOLUTION;
	}	
	else if (ADC_Side_Rangefinder_Config == ADC_Side_Rangefinder_CFG2)
	{
	    resolution = ADC_Side_Rangefinder_CFG2_RESOLUTION;
	}
	else if (ADC_Side_Rangefinder_Config == ADC_Side_Rangefinder_CFG3)
	{
    ...
    mVolts = ((A * adcCounts) / ((int32)ADC_Side_Rangefinder_CountsPerVolt/B)) ;   
...
/*******************************************************************************
* Function Name: ADC_Side_Rangefinder_CountsTo_Volts
********************************************************************************
*
* Summary:
...
*
* Global variables:
*  ADC_Side_Rangefinder_CountsPerVolt:  used to convert to Volts.
*  ADC_Side_Rangefinder_Offset:  Used as the offset while converting ADC counts 
*   to Volts.
*
*******************************************************************************/
float ADC_Side_Rangefinder_CountsTo_Volts( int32 adcCounts) 
{
    ...
    Volts = (float)adcCounts / (float)ADC_Side_Rangefinder_CountsPerVolt;   
...
/*******************************************************************************
* Function Name: ADC_Side_Rangefinder_CountsTo_uVolts
********************************************************************************
*
* Summary:
...
* resolution.
*
* uVolts = ((A * adcCounts) / ((int32)ADC_Side_Rangefinder_CountsPerVolt/B)) ;   
*
*  Resolution       A           B
*   8 - 11      1,000,000         1
*  12 - 14        100,000        10
...
/*******************************************************************************
* Function Name: ADC_Side_Rangefinder_IRQ_Start(void)
********************************************************************************
*
* Summary:
...
void ADC_Side_Rangefinder_IRQ_Start(void) 
{
    ...
    CyIntDisable(ADC_Side_Rangefinder_IRQ__INTC_NUMBER );

    /* Set the ISR to point to the ADC_DelSig_1_IRQ Interrupt. */
    CyIntSetVector(ADC_Side_Rangefinder_IRQ__INTC_NUMBER, ADC_Side_Rangefinder_ISR1);

    /* Set the priority. */
    CyIntSetPriority(ADC_Side_Rangefinder_IRQ__INTC_NUMBER, ADC_Side_Rangefinder_IRQ_INTC_PRIOR_NUMBER);
...
/*******************************************************************************
* Function Name: ADC_Side_Rangefinder_InitConfig(uint8 config)
********************************************************************************
*
* Summary:
...
*
* Global variables:
*  ADC_Side_Rangefinder_initVar:  used to set the common registers in the beginning.
*  ADC_Side_Rangefinder_CountsPerVolt:  Used to set the default counts per volt.
*
*******************************************************************************/
void ADC_Side_Rangefinder_InitConfig(uint8 config) 
{
    ADC_Side_Rangefinder_stopConversion = 0u;
    
    if(ADC_Side_Rangefinder_initVar == 0u)
        {
            ADC_Side_Rangefinder_DSM_DEM0_REG    = ADC_Side_Rangefinder_CFG1_DSM_DEM0;    
            ADC_Side_Rangefinder_DSM_DEM1_REG    = ADC_Side_Rangefinder_CFG1_DSM_DEM1;    
            ADC_Side_Rangefinder_DSM_MISC_REG    = ADC_Side_Rangefinder_CFG1_DSM_MISC;    
            ADC_Side_Rangefinder_DSM_CLK_REG    |= ADC_Side_Rangefinder_CFG1_DSM_CLK; 
            ADC_Side_Rangefinder_DSM_REF1_REG    = ADC_Side_Rangefinder_CFG1_DSM_REF1;    
        
            ADC_Side_Rangefinder_DSM_OUT0_REG    = ADC_Side_Rangefinder_CFG1_DSM_OUT0;    
            ADC_Side_Rangefinder_DSM_OUT1_REG    = ADC_Side_Rangefinder_CFG1_DSM_OUT1;   
        
            ADC_Side_Rangefinder_DSM_CR0_REG     = ADC_Side_Rangefinder_CFG1_DSM_CR0;     
            ADC_Side_Rangefinder_DSM_CR1_REG     = ADC_Side_Rangefinder_CFG1_DSM_CR1;     
            ADC_Side_Rangefinder_DSM_CR2_REG     = ADC_Side_Rangefinder_CFG1_DSM_CR2;     
            ADC_Side_Rangefinder_DSM_CR3_REG     = ADC_Side_Rangefinder_CFG1_DSM_CR3;     
            ADC_Side_Rangefinder_DSM_CR13_REG    = ADC_Side_Rangefinder_CFG1_DSM_CR13;     
            
            ADC_Side_Rangefinder_DEC_SR_REG      = ADC_Side_Rangefinder_CFG1_DEC_SR;      
            ADC_Side_Rangefinder_DEC_COHER_REG   = ADC_Side_Rangefinder_CFG1_DEC_COHER;   
        }

    if (config == 1u)
    {
        /* Default Config */   
        ADC_Side_Rangefinder_DEC_CR_REG      = ADC_Side_Rangefinder_CFG1_DEC_CR;      
        ADC_Side_Rangefinder_DEC_SHIFT1_REG  = ADC_Side_Rangefinder_CFG1_DEC_SHIFT1;  
        ADC_Side_Rangefinder_DEC_SHIFT2_REG  = ADC_Side_Rangefinder_CFG1_DEC_SHIFT2;  
        ADC_Side_Rangefinder_DEC_DR2_REG     = ADC_Side_Rangefinder_CFG1_DEC_DR2;     
        ADC_Side_Rangefinder_DEC_DR2H_REG    = ADC_Side_Rangefinder_CFG1_DEC_DR2H;    
        ADC_Side_Rangefinder_DEC_DR1_REG     = ADC_Side_Rangefinder_CFG1_DEC_DR1;     
        ADC_Side_Rangefinder_DEC_OCOR_REG    = ADC_Side_Rangefinder_CFG1_DEC_OCOR;    
        ADC_Side_Rangefinder_DEC_OCORM_REG   = ADC_Side_Rangefinder_CFG1_DEC_OCORM;   
        ADC_Side_Rangefinder_DEC_OCORH_REG   = ADC_Side_Rangefinder_CFG1_DEC_OCORH;   
        
        ADC_Side_Rangefinder_DSM_CR4_REG     = ADC_Side_Rangefinder_CFG1_DSM_CR4;     
        ADC_Side_Rangefinder_DSM_CR5_REG     = ADC_Side_Rangefinder_CFG1_DSM_CR5;     
        ADC_Side_Rangefinder_DSM_CR6_REG     = ADC_Side_Rangefinder_CFG1_DSM_CR6;     
        ADC_Side_Rangefinder_DSM_CR7_REG     = ADC_Side_Rangefinder_CFG1_DSM_CR7;     
        ADC_Side_Rangefinder_DSM_CR8_REG     = ADC_Side_Rangefinder_CFG1_DSM_CR8;     
        ADC_Side_Rangefinder_DSM_CR9_REG     = ADC_Side_Rangefinder_CFG1_DSM_CR9;     
        ADC_Side_Rangefinder_DSM_CR10_REG    = ADC_Side_Rangefinder_CFG1_DSM_CR10;    
        ADC_Side_Rangefinder_DSM_CR11_REG    = ADC_Side_Rangefinder_CFG1_DSM_CR11;    
        ADC_Side_Rangefinder_DSM_CR12_REG    = ADC_Side_Rangefinder_CFG1_DSM_CR12;    
        ADC_Side_Rangefinder_DSM_CR14_REG    = ADC_Side_Rangefinder_CFG1_DSM_CR14;    
        ADC_Side_Rangefinder_DSM_CR15_REG    = ADC_Side_Rangefinder_CFG1_DSM_CR15;    
        ADC_Side_Rangefinder_DSM_CR16_REG    = ADC_Side_Rangefinder_CFG1_DSM_CR16;    
        ADC_Side_Rangefinder_DSM_CR17_REG    = ADC_Side_Rangefinder_CFG1_DSM_CR17;
		/* Set DSM_REF0_REG by disabling and enabling the PRESS cirucit */
		ADC_Side_Rangefinder_SetDSMRef0Reg(ADC_Side_Rangefinder_CFG1_DSM_REF0);
        ADC_Side_Rangefinder_DSM_REF2_REG    = ADC_Side_Rangefinder_CFG1_DSM_REF2;    
        ADC_Side_Rangefinder_DSM_REF3_REG    = ADC_Side_Rangefinder_CFG1_DSM_REF3;    
        
        ADC_Side_Rangefinder_DSM_BUF0_REG    = ADC_Side_Rangefinder_CFG1_DSM_BUF0;    
        ADC_Side_Rangefinder_DSM_BUF1_REG    = ADC_Side_Rangefinder_CFG1_DSM_BUF1;    
        ADC_Side_Rangefinder_DSM_BUF2_REG    = ADC_Side_Rangefinder_CFG1_DSM_BUF2;   
        ADC_Side_Rangefinder_DSM_BUF3_REG    = ADC_Side_Rangefinder_CFG1_DSM_BUF3;
        #if (CY_PSOC5A)
            ADC_Side_Rangefinder_DSM_CLK_REG    |= ADC_Side_Rangefinder_CFG1_DSM_CLK; 
        #endif /* CY_PSOC5A */
        ...
        */
        ...
        #if(ADC_Side_Rangefinder_CFG1_RESOLUTION > 16 && \
            ADC_Side_Rangefinder_CFG1_CONV_MODE == ADC_Side_Rangefinder_MODE_SINGLE_SAMPLE) 
            ADC_Side_Rangefinder_stopConversion = 1;
        #endif /* Single sample with resolution above 16 bits. */
        ADC_Side_Rangefinder_CountsPerVolt = (uint32)ADC_Side_Rangefinder_CFG1_COUNTS_PER_VOLT;
    ...
    #if(ADC_Side_Rangefinder_DEFAULT_NUM_CONFIGS > 1)
        if(config == 2u)
        {
            /* Second Config */
    ...
    #if(ADC_Side_Rangefinder_DEFAULT_NUM_CONFIGS > 2)
        if(config == 3u)
        {
            /* Third Config */
    ...
    #if(ADC_Side_Rangefinder_DEFAULT_NUM_CONFIGS == 4)
        if (config == 4u)
        {
            /* Fourth Config */
...
/*******************************************************************************
* Function Name: ADC_Side_Rangefinder_RoundValue(uint32 busClockFreq, 
*                                            uint32 clockFreq)
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: ADC_Side_Rangefinder_SelectCofiguration(uint8 config, 
*                                                    uint8 restart)
********************************************************************************
*
* Summary:
                                              ...
                                              
{
    ...
    {   
       /* Set the flag to ensure start() API dont override the config
        ...
        ADC_Side_Rangefinder_InitConfig(config);
        
        /* Trim value calculation */
        if(config == 1u)
        {
            inputRange = ADC_Side_Rangefinder_CFG1_RANGE;
            resolution = ADC_Side_Rangefinder_CFG1_RESOLUTION;
            idealGain = ADC_Side_Rangefinder_CFG1_IDEAL_DEC_GAIN;
            idealOddGain = ADC_Side_Rangefinder_CFG1_IDEAL_ODDDEC_GAIN;
            adcClockDivider = ADC_Side_Rangefinder_RoundValue((uint32)BCLK__BUS_CLK__HZ,
                                                       (uint32)ADC_Side_Rangefinder_CFG1_CLOCK_FREQ);
            cpClockDivider = ADC_Side_Rangefinder_RoundValue((uint32)BCLK__BUS_CLK__HZ,
                                                       (uint32)ADC_Side_Rangefinder_CFG1_CP_CLOCK_FREQ);
        }
        ...
        #if (ADC_Side_Rangefinder_DEFAULT_NUM_CONFIGS > 3)
            if(config == 4u)
            {
        ...
        #if(ADC_Side_Rangefinder_DEFAULT_INTERNAL_CLK)
            ADC_Side_Rangefinder_theACLK_SetDividerRegister(adcClockDivider, 1);
        #endif /* ADC_Side_Rangefinder_DEFAULT_INTERNAL_CLK */
        
        cpClockDivider = cpClockDivider - 1;
        /* Set the proper divider for the Charge pump clock */
        ADC_Side_Rangefinder_Ext_CP_Clk_SetDividerRegister(cpClockDivider, 1);
        
        /* Compensate the gain */
        ADC_Side_Rangefinder_GainCompensation(inputRange, idealGain, idealOddGain, resolution);
        ...
        {        
            ...
            #if (((ADC_Side_Rangefinder_CFG2_REFERENCE == ADC_Side_Rangefinder_EXT_REF_ON_P03) || \
...
/*******************************************************************************
* Function Name: ADC_Side_Rangefinder_GainCompensation(uint8, uint16, uint16, uint8)
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void ADC_Side_Rangefinder_GainCompensation(uint8 inputRange, uint16 IdealDecGain, uint16 IdealOddDecGain,  \
                                       uint8 resolution) 
{
    int8 flash;
    int16 Normalised;
    ...
    switch(inputRange)
    {         
        case ADC_Side_Rangefinder_IR_VNEG_VREF_DIFF:
        
        /* Normalize the flash Value */
        if(resolution > 15)
        {
            flash = ADC_Side_Rangefinder_DEC_TRIM_VREF_DIFF_16_20; 
        }    
        else
        {
            flash = ADC_Side_Rangefinder_DEC_TRIM_VREF_DIFF_8_15;
        }        
        break;
        
        case ADC_Side_Rangefinder_IR_VNEG_VREF_2_DIFF:
        
        /* Normalize the flash Value */
        if(resolution > 15)
        {
            flash = ADC_Side_Rangefinder_DEC_TRIM_VREF_2_DIFF_16_20;
        }    
        else
        {
            flash = ADC_Side_Rangefinder_DEC_TRIM_VREF_2_DIFF_8_15;
        }    
        break;
        
        case ADC_Side_Rangefinder_IR_VNEG_VREF_4_DIFF:
        
        /* Normalize the flash Value */
        if(resolution > 15)
        {
            flash = ADC_Side_Rangefinder_DEC_TRIM_VREF_4_DIFF_16_20;
        }    
        else
        {
            flash = ADC_Side_Rangefinder_DEC_TRIM_VREF_4_DIFF_8_15;
        }    
        break;
        
        case ADC_Side_Rangefinder_IR_VNEG_VREF_16_DIFF:
        
        /* Normalize the flash Value */
        if(resolution > 15)
        {
            flash = ADC_Side_Rangefinder_DEC_TRIM_VREF_16_DIFF_16_20;
        }    
        else
        {
            flash = ADC_Side_Rangefinder_DEC_TRIM_VREF_16_DIFF_8_15;
        }    
        break;
    ...
    if(inputRange == ADC_Side_Rangefinder_IR_VSSA_TO_VREF || inputRange == ADC_Side_Rangefinder_IR_VSSA_TO_2VREF || 
       inputRange == ADC_Side_Rangefinder_IR_VSSA_TO_VDDA || inputRange == ADC_Side_Rangefinder_IR_VSSA_TO_6VREF || 
       inputRange == ADC_Side_Rangefinder_IR_VNEG_2VREF_DIFF || inputRange == ADC_Side_Rangefinder_IR_VNEG_6VREF_DIFF ||
       inputRange == ADC_Side_Rangefinder_IR_VNEG_VREF_8_DIFF)
    {
        Normalised  = 0;
    }
    else
    ...
    GcorValue = (uint16)(GcorTmp / ADC_Side_Rangefinder_IDEAL_GAIN_CONST);
        
    if (resolution < 14)
    {
        GcorValue = (GcorValue >> (15 - (resolution + 1)));
        ADC_Side_Rangefinder_DEC_GVAL_REG = (resolution + 1);
    }
    else
    {
        /* Use all 16 bits */
        ADC_Side_Rangefinder_DEC_GVAL_REG = 15u;  
    }
      
    /* Load the gain correction register */    
    ADC_Side_Rangefinder_DEC_GCOR_REG  = (uint8)GcorValue;
    ADC_Side_Rangefinder_DEC_GCORH_REG = (uint8)(GcorValue >> 8);    
...
/******************************************************************************
* Function Name: ADC_Side_Rangefinder_SetDSMRef0Reg(uint8)
******************************************************************************
*
* Summary:
...
void ADC_Side_Rangefinder_SetDSMRef0Reg(uint8 value) 
{
    /* Disable PRES, Enable power to VCMBUF0, REFBUF0 and REFBUF1, enable 
       PRES */
    #if (CY_PSOC3 || CY_PSOC5LP)
        ADC_Side_Rangefinder_RESET_CR4_REG |= (ADC_Side_Rangefinder_IGNORE_PRESA1 | ADC_Side_Rangefinder_IGNORE_PRESD1);
        ADC_Side_Rangefinder_RESET_CR5_REG |= (ADC_Side_Rangefinder_IGNORE_PRESA2 | ADC_Side_Rangefinder_IGNORE_PRESD2);
    #elif (CY_PSOC5A)
        ADC_Side_Rangefinder_RESET_CR1_REG |= ADC_Side_Rangefinder_DIS_PRES1;
        ADC_Side_Rangefinder_RESET_CR3_REG |= ADC_Side_Rangefinder_DIS_PRES2;
    #endif /* CY_PSOC5A */
        ADC_Side_Rangefinder_DSM_REF0_REG = value;   
