    ...
    {   
       /* Set the flag to ensure start() API dont override the config
        ...
        if(config == 1u)
        {
            ...
            adcClockDivider = ADC_DelSig_RoundValue((uint32)BCLK__BUS_CLK__HZ,
                                                       (uint32)ADC_DelSig_CFG1_CLOCK_FREQ);
            cpClockDivider = ADC_DelSig_RoundValue((uint32)BCLK__BUS_CLK__HZ,
                                                       (uint32)ADC_DelSig_CFG1_CP_CLOCK_FREQ);
        }
            ...
            if(config == 2u)
            {
                ...
                cpClockDivider = ADC_DelSig_RoundValue((uint32)BCLK__BUS_CLK__HZ,
                                                       (uint32)ADC_DelSig_CFG2_CP_CLOCK_FREQ);
            }
        #endif /* ADC_DelSig_DEFAULT_NUM_CONFIGS > 1 */
            ...
            if(config == 3u)
            {
                ...
                cpClockDivider = ADC_DelSig_RoundValue((uint32)BCLK__BUS_CLK__HZ,
                                                       (uint32)ADC_DelSig_CFG3_CP_CLOCK_FREQ);
            }
            ...
            if(config == 4u)
            {
                ...
                cpClockDivider = ADC_DelSig_RoundValue((uint32)BCLK__BUS_CLK__HZ,
                                                       (uint32)ADC_DelSig_CFG4_CP_CLOCK_FREQ);
            }
        #endif /* ADC_DelSig_DEFAULT_NUM_CONFIGS > 3 */
        ...
        #if(ADC_DelSig_DEFAULT_INTERNAL_CLK)
            ADC_DelSig_theACLK_SetDividerRegister(adcClockDivider, 1);
        #endif /* ADC_DelSig_DEFAULT_INTERNAL_CLK */
        
        cpClockDivider = cpClockDivider - 1;
        /* Set the proper divider for the Charge pump clock */
        ADC_DelSig_Ext_CP_Clk_SetDividerRegister(cpClockDivider, 1);
