...
// I2C_v3_10(Address_Decode=1, BusSpeed_kHz=50, CtlModeReplacementString=SyncCtl, EnableWakeup=false, FF=true, Hex=false, I2C_Mode=2, I2cBusPort=0, Implementation=1, NotSlaveClockMinusTolerance=25, NotSlaveClockPlusTolerance=5, Slave_Address=8, SlaveClockMinusTolerance=5, SlaveClockPlusTolerance=50, UDB_MSTR=false, UDB_MULTI_MASTER_SLAVE=false, UDB_SLV=false, UdbInternalClock=false, UdbRequiredClock=800, UdbSlaveFixedPlacementEnable=false, CY_COMPONENT_NAME=I2C_v3_10, CY_CONTROL_FILE=I2C_Slave_DefaultPlacement.ctl, CY_FITTER_NAME=I2C_Pressure, CY_INSTANCE_SHORT_NAME=I2C_Pressure, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=10, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=cydsfit No Version Information Found, INSTANCE_NAME=I2C_Pressure, )
module I2C_v3_10_13 (
    sda,
    scl,
    clock,
	...
	assign Net_767 = clock;


	cy_clock_v1_0
		#(.id("e0ed9355-43c1-4ae0-9f3e-df4b82ba2b4e/5ece924d-20ba-480e-9102-bc082dcdd926"),
...
// Counter_v2_20(CaptureMode=0, CaptureModeSoftware=0, ClockMode=3, CompareMode=1, CompareModeSoftware=0, CompareStatusEdgeSense=true, CompareValue=0, CONTROL3=1, ControlRegRemoved=0, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, EnableMode=0, FF16=true, FF8=false, FixedFunction=true, FixedFunctionUsed=1, InitCounterValue=500, InterruptOnCapture=false, InterruptOnCompare=false, InterruptOnOverUnderFlow=false, InterruptOnTC=true, Period=500, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, ReloadOnCapture=false, ReloadOnCompare=false, ReloadOnOverUnder=true, ReloadOnReset=true, Resolution=16, RstStatusReplacementString=sSTSReg_rstSts, RunMode=1, UDB16=false, UDB24=false, UDB32=false, UDB8=false, UDBControlReg=false, UseInterrupt=true, VerilogSectionReplacementString=sC16, CY_COMPONENT_NAME=Counter_v2_20, CY_CONTROL_FILE=<:default:>, CY_FITTER_NAME=Altimeter_Counter, CY_INSTANCE_SHORT_NAME=Altimeter_Counter, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=20, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=cydsfit No Version Information Found, INSTANCE_NAME=Altimeter_Counter, )
module Counter_v2_20_14 (
    clock,
    comp,
    tc,
    reset,
...
// Comp_v1_90(Hysteresis=0, Pd_Override=0, Polarity=1, PSOC5A=false, Speed=0, Sync=0, CY_COMPONENT_NAME=Comp_v1_90, CY_CONTROL_FILE=<:default:>, CY_FITTER_NAME=Side_Rangefinder_Comparator, CY_INSTANCE_SHORT_NAME=Side_Rangefinder_Comparator, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=cydsfit No Version Information Found, INSTANCE_NAME=Side_Rangefinder_Comparator, )
module Comp_v1_90_15 (
    Vplus,
    CmpOut,
    Vminus,
    clock);
...
// ADC_Vssa_v1_20(CY_COMPONENT_NAME=ADC_Vssa_v1_20, CY_CONTROL_FILE=<:default:>, CY_FITTER_NAME=ADC_Vssa_1, CY_INSTANCE_SHORT_NAME=ADC_Vssa_1, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=20, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=cydsfit No Version Information Found, INSTANCE_NAME=ADC_Side_Rangefinder_ADC_Vssa_1, )
module ADC_Vssa_v1_20_16 (
    vout);
    inout       vout;
    electrical  vout;
...
module ADC_DelSig_v2_30_17 (
	...
	cy_clock_v1_0
		#(.id("2369587e-c005-4224-8ee7-9a5b90bdbd06/edd15f43-b66b-457b-be3a-5342345270c8"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
		  .period("610500610.50061"),
		  .is_direct(0),
		  .is_digital(0))
		theACLK
		 (.clock_out(Net_40));
	...
	cy_clock_v1_0
		#(.id("2369587e-c005-4224-8ee7-9a5b90bdbd06/b7604721-db56-4477-98c2-8fae77869066"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
		  .period("152625152.625153"),
		  .is_direct(0),
		  .is_digital(1))
		Ext_CP_Clk
		 (.clock_out(Net_487));
...
module top ;
    ...
    begin : mux_1
        reg  tmp__mux_1_reg;
        always @(Net_2046 or Net_2071 or Net_2263)
        begin
            case (Net_2263)
	...
	wire [0:0] tmpOE__Pressure_SCL_net;
	wire [0:0] tmpFB_0__Pressure_SCL_net;
	wire [0:0] tmpINTERRUPT_0__Pressure_SCL_net;
	electrical [0:0] tmpSIOVREF__Pressure_SCL_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("7055d5a5-8423-4c7e-bcba-0b482015ea46"),
		  ...
		  .width(1))
		Pressure_SCL
		 (.oe(tmpOE__Pressure_SCL_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pressure_SCL_net[0:0]}),
		  .io({Net_2228}),
		  .siovref(tmpSIOVREF__Pressure_SCL_net),
		  .interrupt({tmpINTERRUPT_0__Pressure_SCL_net[0:0]}));

	assign tmpOE__Pressure_SCL_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pressure_SDA_net;
	wire [0:0] tmpFB_0__Pressure_SDA_net;
	wire [0:0] tmpINTERRUPT_0__Pressure_SDA_net;
	electrical [0:0] tmpSIOVREF__Pressure_SDA_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("5c1decb5-69e3-4a8d-bb0c-281221d15217"),
		  ...
		  .width(1))
		Pressure_SDA
		 (.oe(tmpOE__Pressure_SDA_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pressure_SDA_net[0:0]}),
		  .io({Net_2227}),
		  .siovref(tmpSIOVREF__Pressure_SDA_net),
		  .interrupt({tmpINTERRUPT_0__Pressure_SDA_net[0:0]}));

	assign tmpOE__Pressure_SDA_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    Counter_v2_20_14 Altimeter_Counter (
        .reset(1'b0),
        .tc(Net_2255),
        .comp(Net_2256),
        .clock(Net_2243),
        ...
        .up_ndown(1'b1),
        .count(1'b0));
    defparam Altimeter_Counter.CaptureMode = 0;
    defparam Altimeter_Counter.ClockMode = 3;
    defparam Altimeter_Counter.CompareMode = 1;
    defparam Altimeter_Counter.CompareStatusEdgeSense = 1;
    defparam Altimeter_Counter.EnableMode = 0;
    defparam Altimeter_Counter.ReloadOnCapture = 0;
    defparam Altimeter_Counter.ReloadOnCompare = 0;
    defparam Altimeter_Counter.ReloadOnOverUnder = 1;
    defparam Altimeter_Counter.ReloadOnReset = 1;
    defparam Altimeter_Counter.Resolution = 16;
    defparam Altimeter_Counter.RunMode = 1;
    defparam Altimeter_Counter.UseInterrupt = 1;


	cy_clock_v1_0
		#(.id("b02a85d9-733e-433a-b75a-5377184cdb0d"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("10000000000000"),
		  .is_direct(0),
	...
	wire [0:0] tmpOE__Pixy_Input_net;
	wire [0:0] tmpIO_0__Pixy_Input_net;
	wire [0:0] tmpINTERRUPT_0__Pixy_Input_net;
	electrical [0:0] tmpSIOVREF__Pixy_Input_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("017c5dcd-811f-4e4f-bc5d-781a168c4c98"),
		  ...
		  .width(1))
		Pixy_Input
		 (.oe(tmpOE__Pixy_Input_net),
		  .y({1'b0}),
		  .fb({Net_2265}),
		  .io({tmpIO_0__Pixy_Input_net[0:0]}),
		  .siovref(tmpSIOVREF__Pixy_Input_net),
		  .interrupt({tmpINTERRUPT_0__Pixy_Input_net[0:0]}));

	assign tmpOE__Pixy_Input_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__side_rangefinder_net;
	wire [0:0] tmpFB_0__side_rangefinder_net;
	wire [0:0] tmpIO_0__side_rangefinder_net;
	wire [0:0] tmpINTERRUPT_0__side_rangefinder_net;
	electrical [0:0] tmpSIOVREF__side_rangefinder_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("3a04dd44-b298-4faa-af49-82244aeafec4"),
		  ...
		  .width(1))
		side_rangefinder
		 (.oe(tmpOE__side_rangefinder_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__side_rangefinder_net[0:0]}),
		  .analog({Net_2266}),
		  .io({tmpIO_0__side_rangefinder_net[0:0]}),
		  .siovref(tmpSIOVREF__side_rangefinder_net),
		  .interrupt({tmpINTERRUPT_0__side_rangefinder_net[0:0]}));
	...
	cy_clock_v1_0
		#(.id("198a7cb6-2fb3-4b5a-afb3-f76b5e75d228"),
		  .source_clock_id("75C2148C-3656-4d8a-846D-0CAE99AB6FF7"),
		  .divisor(0),
		  .period("0"),
		  .is_direct(1),
    ...
    ADC_DelSig_v2_30_17 ADC_Side_Rangefinder (
        .vplus(Net_2266),
        .vminus(Net_2285),
        .soc(1'b1),
        .eoc(Net_2287),
