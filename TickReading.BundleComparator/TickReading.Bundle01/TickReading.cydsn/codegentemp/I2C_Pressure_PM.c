...
I2C_Pressure_BACKUP_STRUCT I2C_Pressure_backup =
{   
    0u, /* enableState */
    
    #if (I2C_Pressure_IMPLEMENTATION == I2C_Pressure_FF)
        I2C_Pressure_DEFAULT_XCFG,  /* xcfg */
        I2C_Pressure_DEFAULT_CFG,   /* cfg */
        ...
        #else
            LO8(I2C_Pressure_DEFAULT_DIVIDE_FACTOR), /*  clk_div1 */
            HI8(I2C_Pressure_DEFAULT_DIVIDE_FACTOR), /*  clk_div2 */
        #endif  /* End (CY_PSOC5A) */
...
/*******************************************************************************
* Function Name: I2C_Pressure_SaveConfig
********************************************************************************
*
* Summary:
...
*
* Global Variables:
*  I2C_Pressure_backup - used to save component configuration and none-retention
...
void I2C_Pressure_SaveConfig(void) 
{
        ...
        I2C_Pressure_backup.cfg  = I2C_Pressure_CFG_REG;
        I2C_Pressure_backup.xcfg = I2C_Pressure_XCFG_REG;
...
/*******************************************************************************
* Function Name: I2C_Pressure_Sleep
********************************************************************************
*
* Summary:
...
void I2C_Pressure_Sleep(void) 
{
        ...
        if (I2C_Pressure_IS_I2C_ENABLE(I2C_Pressure_I2C_ENABLE_REG))
        {
    ...
    I2C_Pressure_SaveConfig();
}


/*******************************************************************************
* Function Name: I2C_Pressure_RestoreConfig
********************************************************************************
*
* Summary:
...
*
* Global Variables:
*  I2C_Pressure_backup - used to save component configuration and 
...
void I2C_Pressure_RestoreConfig(void) 
{
            ...
            else
            {
                ...
                I2C_Pressure_XCFG_REG = I2C_Pressure_backup.xcfg;
                I2C_Pressure_CFG_REG  = I2C_Pressure_backup.cfg;
...
/*******************************************************************************
* Function Name: I2C_Pressure_Wakeup
********************************************************************************
*
* Summary:
*  Wakeup on address match enabled: enables I2C Master (if was enabled before go
...
void I2C_Pressure_Wakeup(void) 
{
    ...
    I2C_Pressure_RestoreConfig();
    
    /* Restore I2C Enable state */
    if (0u != I2C_Pressure_backup.enableState)
    {
        I2C_Pressure_Enable();
    }
}
