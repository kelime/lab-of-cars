...
# Date: Tue, 28 Apr 2015 08:55:20 GMT
#set_units -time ns
create_clock -name {CyBUS_CLK(routed)} -period 41.666666666666664 -waveform {0 20.8333333333333} [get_pins {ClockBlock/clk_bus}]
create_clock -name {ADC_DelSig_Ext_CP_Clk(routed)} -period 541.66666666666663 -waveform {0 270.833333333333} [get_pins {ClockBlock/dclk_0}]
...
create_generated_clock -name {ADC_DelSig_Ext_CP_Clk} -source [get_pins {ClockBlock/clk_sync}] -edges {1 13 27} -nominal_period 541.66666666666663 [list [get_pins {ClockBlock/dclk_glb_0}]]
create_generated_clock -name {ADC_DelSig_theACLK} -source [get_pins {ClockBlock/clk_sync}] -edges {1 53 105} -nominal_period 2166.6666666666665 [list [get_pins {ClockBlock/aclk_glb_0}]]
...
# Project: C:\Users\Emmily\!Spring2015\CarLab\TickReading.BundleComparator\TickReading.BundleComparator\TickReading.Bundle01\TickReading.cydsn\TickReading.cyprj
# Date: Tue, 28 Apr 2015 08:55:10 GMT
