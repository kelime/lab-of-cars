...
{
    if (Clock_Steering_CLKEN & Clock_Steering_CLKEN_MASK)
    {
...
*
*******************************************************************************/
void Clock_Steering_SetModeRegister(uint8 clkMode) 
{
    Clock_Steering_MOD_SRC |= clkMode & Clock_Steering_MODE_MASK;
}
...
*
*******************************************************************************/
void Clock_Steering_ClearModeRegister(uint8 clkMode) 
{
    Clock_Steering_MOD_SRC &= ~clkMode | ~Clock_Steering_MODE_MASK;
}
...
{
    return Clock_Steering_MOD_SRC & Clock_Steering_MODE_MASK;
}
...
void Clock_Steering_SetSourceRegister(uint8 clkSource) 
{
    ...
    if (oldSrc != CYCLK_SRC_SEL_CLK_SYNC_D && clkSource == CYCLK_SRC_SEL_CLK_SYNC_D && currDiv == 0)
    {
        ...
        Clock_Steering_MOD_SRC =
            (Clock_Steering_MOD_SRC & ~Clock_Steering_SRC_SEL_MSK) | clkSource;
    }
