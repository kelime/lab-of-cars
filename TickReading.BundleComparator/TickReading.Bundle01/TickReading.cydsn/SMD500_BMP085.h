 ...
 *
 * 2. calling the bmp085_init() routine, which initializes all necessary datum structures for using all functions
 *
 *
 * 
...
#define bmp085_read_reg(address, datum, length)\
                bmp085_get_reg(address, datum, length)

#define bmp085_write_reg(address, datum, length)\
                bmp085_set_reg(address, datum, length)
...
*/
#define BMP085_BUS_WR_PARAM_ORDER device_addr, register_addr, register_datum, write_length


/* never change this line */
#define BMP085_BUS_WRITE_FUNC(device_addr, register_addr, register_datum, write_length)\
           bus_write( device_addr, register_addr, register_datum, write_length )
...
*/
#define BMP085_BUS_RD_PARAM_ORDER device_addr, register_addr, register_datum, read_length



/* never change this line */
#define BMP085_BUS_READ_FUNC(device_addr, register_addr, register_datum, read_length)\
           bus_read( device_addr, register_addr, register_datum, read_length )
...
#define BMP085_PROM_DATUM__LEN             22
...
#define SMD500_PROM_datum__LEN           8
...
#define BMP085_MDELAY_datum_TYPE unsigned int
...
/** BMP085 image registers datum structure
...
typedef struct  {       
        ...
        BMP085_MDELAY_RETURN_TYPE (*delay_msec)( BMP085_MDELAY_datum_TYPE );
} bmp085_t;
...
/* read: address, datum-pointer, length */
...
/* write: address, datum-pointer, length */
