...
********************************************************************************/
#if !defined(__ISR_Counter_INTC_H__)
#define __ISR_Counter_INTC_H__
...
#include <cyfitter.h>
        ...
        #include <intrins.h>
        #define ISR_Counter_ISR_PATCH() _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_();
    #endif
#endif
...
#define ISR_Counter_INTC_VECTOR            ((reg16 *) ISR_Counter__INTC_VECT)
...
#define ISR_Counter_INTC_SET_EN            ((reg8 *) ISR_Counter__INTC_SET_EN_REG)

/* Address of the INTC.CLR_EN[x] register to bit clear the ISR_Counter interrupt. */
#define ISR_Counter_INTC_CLR_EN            ((reg8 *) ISR_Counter__INTC_CLR_EN_REG)

/* Address of the INTC.SET_PD[x] register to set the ISR_Counter interrupt state to pending. */
#define ISR_Counter_INTC_SET_PD            ((reg8 *) ISR_Counter__INTC_SET_PD_REG)

/* Address of the INTC.CLR_PD[x] register to clear the ISR_Counter interrupt. */
#define ISR_Counter_INTC_CLR_PD            ((reg8 *) ISR_Counter__INTC_CLR_PD_REG)



/* __ISR_Counter_INTC_H__ */
#endif
