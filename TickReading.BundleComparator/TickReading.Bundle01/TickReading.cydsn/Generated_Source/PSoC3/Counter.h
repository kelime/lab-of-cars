 ...
 **************************************/
#define Counter_INIT_PERIOD_VALUE       16777215u
...
#define Counter_INIT_INTERRUPTS_MASK ((0u << Counter_STATUS_ZERO_INT_EN_MASK_SHIFT) | \
        ...
        (1u << Counter_STATUS_OVERFLOW_INT_EN_MASK_SHIFT) | \
        (1u << Counter_STATUS_UNDERFLOW_INT_EN_MASK_SHIFT))
 ...
 *************************************/
    ...
    #define Counter_AUX_CONTROLDP0_PTR \
       ...
       #define Counter_AUX_CONTROLDP1 \
           (*(reg8 *) Counter_CounterUDB_sC24_counterdp_u1__DP_AUX_CTL_REG)
       ...
       #define Counter_AUX_CONTROLDP2 \
           (*(reg8 *) Counter_CounterUDB_sC24_counterdp_u2__DP_AUX_CTL_REG)
       ...
       #define Counter_AUX_CONTROLDP3 \
           (*(reg8 *) Counter_CounterUDB_sC24_counterdp_u3__DP_AUX_CTL_REG)
