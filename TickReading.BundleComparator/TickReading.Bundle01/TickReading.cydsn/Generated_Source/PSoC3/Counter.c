                                   ...
                                   
{
        ...
        Counter_GLOBAL_ENABLE &= ~Counter_BLOCK_EN_MASK;
    #else
        CY_SET_REG24(Counter_COUNTER_LSB_PTR, counter);
    #endif /* (Counter_UsingFixedFunction) */
}
#endif /* (!(Counter_UsingFixedFunction && (CY_PSOC5A))) */
...
uint32 Counter_ReadCounter(void) 
{
    ...
    return (CY_GET_REG24(Counter_STATICCOUNT_LSB_PTR));
}
...
void Counter_WritePeriod(uint32 period) 
{
    ...
    #else
        CY_SET_REG24(Counter_PERIOD_LSB_PTR,period);
    #endif /* (Counter_UsingFixedFunction) */
}
...
{
   return ( CY_GET_REG24(Counter_PERIOD_LSB_PTR));
}
                                   ...
                                   
{
    ...
    #else
        CY_SET_REG24(Counter_COMPARE_LSB_PTR,compare);
    #endif /* (Counter_UsingFixedFunction) */
}
...
{
   return ( CY_GET_REG24(Counter_COMPARE_LSB_PTR));
}
